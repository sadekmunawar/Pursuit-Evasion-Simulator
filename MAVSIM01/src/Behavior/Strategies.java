...
*Strategy3: See pursuer before getting caught and move in opposite direction; otherwise move randomly
...
*
*Strategy4: Form a chain and make a circle
*Each pick starting location randomly
*Once at if two colliding starting location then the listener changes
*The pursuer on the sides have a higher chance of moving up
*Those in the middle move side to side and slowly move up
*
*In the begining, go straight to the south border, 25% E, 25%W, 0%N, 60%S. 
*Once at the bottom, travel horizontally to find to communicate with other robots and do initial configuration
*
*
*
*
